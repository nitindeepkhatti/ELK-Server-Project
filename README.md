...
<img width="539" alt="Network_Diagram" src="https://user-images.githubusercontent.com/66395625/94220166-02070300-feae-11ea-958e-7dfb9d3862e9.PNG">
   ...
   These files have been tested and used to generate a live ELK deployment on Azure. They can be used to either recreate the entire deployment pictured above. Alternatively, select portions of the _____ file may be used to install only certain pieces of it, such as Filebeat and Metricbeat.
...
|------------ |----------  |-------------- |-------------------------|
| Jump-Box | Gateway  |  10.1.0.8   | Linux(ubuntu 18.04) |
| Web-1     | Server      |  10.1.0.9    | Linux(ubuntu 18.04) |
| Web-2     | Server      |  10.1.0.10  | Linux(ubuntu 18.04) |
| Web-3     | Server      |  10.1.0.11  | Linux(ubuntu 18.04) |
| Elk-VM1 | Elk Server|  10.0.0.4    | Linux(ubuntu 18.04) |
...
- Add whitelisted IP addresses:-
    	- Public IP address which changes every time when the VM is on/off eg of Public IP 137.135.115.14
